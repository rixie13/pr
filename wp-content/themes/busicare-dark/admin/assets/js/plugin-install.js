jQuery(document).ready(function($) {
    'use strict';
    var this_obj = busicare_dark_companion_install;
    ...
    $(document).on('click', '.action-watch', function(event) {
        ...
        if(action_id){
            $.ajax({
                ...
                type: 'POST',
                data: {action: 'busicare_dark_update_rec_acts', action_id:action_id},
                success:function(data) {
    ...
    $(document).on('click', '.spicethemes-customizer-notification-dismiss', function(event) {
        ...
        var sdata = {};
        if(slug){
            sdata.action = 'busicare_dark_hide_customizer_notice';
            sdata.busicare_dark_plugin_slug = slug;
        }else{
            sdata.action = 'busicare_dark_hide_customizer_companion_notice';
        }
